...
def execute_math_tool(client, user_id: str):
...
def handle_github_auth(client, user_id: str):
...
def list_github_repos(client, user_id: str, username: str):
...
def main():
    # Initialize Arcade client using utility function
