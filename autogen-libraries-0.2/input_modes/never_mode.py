...
agent_with_animal = ConversableAgent(
    "agent_with_animal",
    system_message="You are thinking of an animal. You have the animal 'rat' in your mind, and I will try to guess it. "
    "If I guess incorrectly, give me a hint. ",
    llm_config=llm_config,
    is_termination_msg=lambda msg: "goodbye" in msg["content"].lower() or "thank you" in msg["content"].lower(),  # terminate if the animal is guessed
